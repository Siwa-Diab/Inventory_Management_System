...
<body>
        ...
        <div class="sidebar">
            ...
            <div class="dashboard">
               ...
               <a  class="liMainMenu_link">
                ...
                <li><a href="suppliers-view.php"><i class="fa fa-circle"></i>ADD Supplier</a></li>
                </ul>
                <a  class="liMainMenu_link">
    ...
    <form action="supplier-add.php" method="post" class="appForm" enctype="multipart/form-data">

<div class="appFormInputContainer">
    <label for="supplier_name">Supplier Name</label>
    <input type="text" class="appFormInput" id="supplier_name" placeholder="Enter supplier name..." name="supplier_name" value="<?php echo htmlspecialchars(isset($_POST['supplier_name']) ? $_POST['supplier_name'] : ''); ?>">
</div>

<div class="appFormInputContainer">
    <label for="supplier_location">Location</label>
    <input type="text" class="appFormInput productTextAreaInput"  id="supplier_location" placeholder="Enter supplier location..." name="supplier_location" value="<?php echo htmlspecialchars(isset($_POST['supplier_location']) ? $_POST['supplier_location'] : ''); ?>">
    
</div>
<div class="appFormInputContainer">
    <label for="email">Email</label>
    <input type="text" class="appFormInput productTextAreaInput"  id="email" placeholder="Enter supplier email..." name="email" value="<?php echo htmlspecialchars(isset($_POST['email']) ? $_POST['email'] : ''); ?>">
</div>
        <button type="submit" class="appBtn"><i class="fa fa-plus"></i> &nbsp;Create Supplier</button>
           ...
           ?>
             ...
             <div class="responseMessage">
                <p div class="responseMessage"<?php  $is_success ? 'responseMessage__succesa' : 'responseMessage__error' ?>">
